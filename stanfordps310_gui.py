            ...
            <div class="main-content">
                ...
                <div>
                    ...
                    <div class="panel panel-control">
                        ...
                        <div class="ramp-plot-wrapper" style="background: white; border-radius: 6px; padding: 6px; border: 2px solid #e9ecef;">
                            <h3 style="margin: 0 0 3px 0; font-size: 1.0em; color: #333;">📈 Ramp Preview</h3>
